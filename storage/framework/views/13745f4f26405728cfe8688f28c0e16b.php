...
<?php $__env->startSection('subtitle', 'Buyer Dashboard'); ?>
    ...
    <div class="stat-card-modern card-blue dashboard-card-hover group">
        <div class="relative z-10 flex items-start justify-between">
            <div>
                ...
                <p class="text-5xl font-bold text-blue-900 mb-2"><?php echo e($stats['bookings'] ?? 0); ?></p>
    ...
    <div class="stat-card-modern card-emerald dashboard-card-hover group">
        <div class="relative z-10 flex items-start justify-between">
            <div>
                ...
                <p class="text-5xl font-bold text-emerald-900 mb-2"><?php echo e($availableVehiclesCount ?? 0); ?></p>
    ...
    <div class="stat-card-modern card-cyan dashboard-card-hover group">
        <div class="relative z-10 flex items-start justify-between">
            <div>
                ...
                <p class="text-5xl font-bold text-cyan-900 mb-2"><?php echo e($stats['transactions'] ?? 0); ?></p>
...
<div class="mb-8">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <a href="<?php echo e(route('vehicles.browse')); ?>" class="dashboard-card dashboard-card-hover text-center hover:bg-blue-50 group">
        ...
        <a href="<?php echo e(route('bookings.index')); ?>" class="dashboard-card dashboard-card-hover text-center hover:bg-purple-50 group">
            <div class="flex flex-col items-center justify-center gap-3">
...
<div class="mb-8">
    <div class="flex items-center justify-between mb-4">
        ...
        <a href="<?php echo e(route('vehicles.browse')); ?>" class="text-blue-600 hover:text-blue-700 font-semibold text-sm">View All →</a>
    </div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
        <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('vehicles.browse', ['brand' => $brand])); ?>" class="group bg-white rounded-2xl border-2 border-gray-200 p-5 text-center hover:border-blue-500 hover:shadow-lg transition-all duration-300">
                ...
                <p class="text-sm font-semibold text-gray-800 group-hover:text-blue-600 transition-colors"><?php echo e($brand); ?></p>
            </a>
...
<div class="mb-8">
    ...
    <?php if($approvedVehicles->count() > 0): ?>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php $__currentLoopData = $approvedVehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 hover:shadow-xl hover:border-blue-300 transition-all overflow-hidden group card-hover">
                    ...
                    <div class="p-6">
                        <h3 class="text-xl font-bold text-gray-900 mb-1"><?php echo e($vehicle->brand); ?> <?php echo e($vehicle->model); ?></h3>
                        <p class="text-gray-600 text-sm mb-3"><?php echo e($vehicle->year); ?> • <?php echo e(number_format($vehicle->mileage ?? 0)); ?> km</p>

                        <div class="flex items-center justify-between mb-4 pb-4 border-b">

                            <div>
                                <p class="text-blue-600 text-2xl font-bold">Nu. <?php echo e(number_format($vehicle->price)); ?></p>
                            </div>
                        ...
                        <div class="flex gap-2">
                            <a href="<?php echo e(route('vehicles.show', $vehicle)); ?>" class="flex-1 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition text-center block">
                                View Details
                            </a>
                            <a href="<?php echo e(route('bookings.create', $vehicle)); ?>" class="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-lg transition">
                                Book
                            </a>
    ...
    <?php else: ?>
        <div class="bg-white rounded-2xl p-12 text-center">
            ...
            <a href="<?php echo e(route('vehicles.browse')); ?>" class="inline-block px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition">
                Browse All Vehicles
            </a>
        </div>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/CBS/resources/views/dashboard/buyer.blade.php ENDPATH**/ ?>