...
<?php $__env->startSection('subtitle', 'Manage buyer information and contacts'); ?>
            ...
            <div class="stat-badge p-4 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-xl border border-blue-500/30 backdrop-blur-xl">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white"><?php echo e($buyers->total()); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
        ...
        <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="group bg-white border-2 border-gray-200 rounded-2xl p-6 text-center hover:border-blue-600 hover:shadow-lg transition-all duration-300">
                ...
                <p class="font-bold text-gray-800 text-sm group-hover:text-blue-600 transition-colors"><?php echo e($brand['name']); ?></p>
            </div>
                            ...
                            <tr class="hover:bg-white/5 transition-colors duration-200 border-b border-white/5">
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="font-semibold text-white"><?php echo e($buyer->name); ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-gray-300"><?php echo e($buyer->phone); ?></td>
                                <td class="px-6 py-4 text-gray-300"><?php echo e($buyer->email ?: '-'); ?></td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <a href="<?php echo e(route('buyers.edit', $buyer)); ?>" class="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-blue-500/20 text-blue-300 hover:bg-blue-500/30 transition-all font-medium text-sm border border-blue-500/30 hover:border-blue-500/50">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                            </svg>
                                            Edit
                                        </a>
                                        <form method="POST" action="<?php echo e(route('buyers.destroy', $buyer)); ?>" onsubmit="return confirm('Are you sure you want to delete this buyer?')" class="inline">
        ...
        <?php $__currentLoopData = $buyers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $buyer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="buyer-card glass-card p-6 rounded-xl border border-white/10">
                ...
                <div class="flex gap-2 pt-4 border-t border-white/10">
                    <a href="<?php echo e(route('buyers.edit', $buyer)); ?>" class="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-blue-500/20 text-blue-300 hover:bg-blue-500/30 transition-all font-medium text-sm border border-blue-500/30">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                        </svg>
                        Edit
                    </a>
                    <form method="POST" action="<?php echo e(route('buyers.destroy', $buyer)); ?>" onsubmit="return confirm('Are you sure?')" class="flex-1">
                        <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
...
<?php else: ?>
    ...
    <div class="glass-card rounded-2xl p-12 border border-white/10 text-center">
        ...
        <a href="<?php echo e(route('buyers.create')); ?>" class="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white px-6 py-3 rounded-lg transition-all font-semibold">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
            </svg>
            Add First Buyer
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/CBS/resources/views/buyers/index.blade.php ENDPATH**/ ?>