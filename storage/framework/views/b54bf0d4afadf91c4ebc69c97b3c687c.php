...
<?php $__env->startSection('subtitle', 'Seller Dashboard'); ?>
...
<div class="mb-8 bg-gradient-to-r from-purple-600 via-purple-600 to-pink-600 rounded-3xl p-8 text-white shadow-2xl">
    ...
    <p class="text-purple-100 text-lg">You are logged in as a <?php echo e(auth()->user()->hasRole(\App\Models\User::ROLE_BROKER) ? 'broker' : 'seller'); ?></p>
</div>

<?php if(auth()->user()->hasRole(\App\Models\User::ROLE_BROKER) && !auth()->user()->isBrokerLicenseApproved()): ?>
    <div class="mb-8 rounded-2xl border-2 border-amber-300 bg-amber-50 p-6" role="alert" aria-live="polite">
        ...
        <p class="mt-2 text-sm text-amber-800">
            Your dealer license is currently <strong><?php echo e(ucfirst(str_replace('_', ' ', auth()->user()->dealer_license_status))); ?></strong>. You can browse vehicles and manage inquiries with buyers/sellers, but vehicle listing and transaction deal actions will unlock after admin approval.
        </p>
        <a href="<?php echo e(route('broker.license.show')); ?>" class="mt-4 inline-flex items-center rounded-lg bg-amber-600 px-4 py-2 text-sm font-semibold text-white hover:bg-amber-700">
    ...
    <div class="stat-card-modern card-blue dashboard-card-hover">
        <div class="relative z-10 flex items-start justify-between">
            <div>
                ...
                <p class="text-5xl font-bold text-blue-900 mb-2"><?php echo e($stats['vehicles'] ?? 0); ?></p>
    ...
    <div class="stat-card-modern card-emerald dashboard-card-hover">
        <div class="relative z-10 flex items-start justify-between">
            <div>
                ...
                <p class="text-5xl font-bold text-emerald-900 mb-2"><?php echo e($stats['available_vehicles'] ?? 0); ?></p>
    ...
    <div class="stat-card-modern card-purple dashboard-card-hover">
        <div class="relative z-10 flex items-start justify-between">
            <div>
                ...
                <p class="text-5xl font-bold text-purple-900 mb-2"><?php echo e($stats['sold_vehicles'] ?? 0); ?></p>
...
<div class="mb-8">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
        <a href="<?php echo e(route('my-vehicles.create')); ?>" class="dashboard-card dashboard-card-hover text-center hover:bg-blue-50 group">
        ...
        <a href="<?php echo e(route('inquiries.index')); ?>" class="dashboard-card dashboard-card-hover text-center hover:bg-amber-50 group">
            <div class="flex flex-col items-center justify-center gap-3">
        ...
        <a href="<?php echo e(route('transactions.index')); ?>" class="dashboard-card dashboard-card-hover text-center hover:bg-emerald-50 group">
            <div class="flex flex-col items-center justify-center gap-3">
...
<div class="mb-8">
    <div class="flex items-center justify-between mb-4">
        ...
        <a href="<?php echo e(route('vehicles.browse')); ?>" class="text-purple-600 hover:text-purple-700 font-semibold text-sm">View All →</a>
    </div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
        <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('vehicles.browse', ['brand' => $brand])); ?>" class="group bg-white rounded-2xl border-2 border-gray-200 p-5 text-center hover:border-purple-500 hover:shadow-lg transition-all duration-300">
                ...
                <p class="text-sm font-semibold text-gray-800 group-hover:text-purple-600 transition-colors"><?php echo e($brand); ?></p>
            </a>
...
<div class="mb-8">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?php echo e(route('my-vehicles.index')); ?>" class="text-purple-600 hover:text-purple-700 font-semibold text-sm">View All →</a>
    </div>

    <?php if($recentListings->count() > 0): ?>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php $__currentLoopData = $recentListings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow overflow-hidden group">
                    ...
                    <div class="p-5">
                        <!-- Brand and Model -->
                        <h3 class="text-xl font-bold text-gray-900 mb-1"><?php echo e($vehicle->brand); ?> <span class="text-purple-600"><?php echo e($vehicle->model); ?></span></h3>
                        
                        <!-- Year -->
                        <p class="text-gray-600 text-sm mb-4">Year: <?php echo e($vehicle->year); ?></p>

                        <!-- Details Row 1 -->
                        <div class="flex gap-4 mb-4 text-xs text-gray-600 border-t border-b py-3">
                            <div>
                                <p class="font-semibold text-gray-700 mb-1">MILEAGE</p>
                                <p class="text-gray-900 font-bold"><?php echo e(number_format($vehicle->mileage ?? 0)); ?> km</p>
                            </div>
                            <div class="flex-1 text-right">
                                <p class="font-semibold text-gray-700 mb-1">LISTED</p>
                                <p class="text-gray-900 font-bold"><?php echo e($vehicle->created_at->format('M d, Y')); ?></p>
                            </div>
                        </div>
                        ...
                        <?php if($vehicle->vin): ?>
                            <div class="mb-4 bg-gray-100 p-3 rounded-lg border border-gray-300">
                                ...
                                <p class="text-sm font-mono text-gray-900 break-all"><?php echo e($vehicle->vin); ?></p>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="mb-4 bg-green-50 p-4 rounded-xl border border-green-200">
                            ...
                            <p class="text-2xl font-bold text-green-600">
                                <?php echo e($vehicle->currency ?? 'Nu.'); ?> <?php echo e(number_format($vehicle->price ?? 0, 2)); ?>
                        ...
                        <div class="flex gap-2">
                            <a href="<?php echo e(route('vehicles.show', $vehicle)); ?>" class="flex-1 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition flex items-center justify-center gap-2">
                            ...
                            <a href="<?php echo e(route('my-vehicles.edit', $vehicle)); ?>" class="px-3 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold rounded-lg transition">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                </svg>
                            </a>
                            <form action="<?php echo e(route('my-vehicles.destroy', $vehicle)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Are you sure?');">
                                <?php echo csrf_field(); ?>
    ...
    <?php else: ?>
        <div class="bg-white rounded-2xl p-12 text-center">
            ...
            <a href="<?php echo e(route('my-vehicles.create')); ?>" class="inline-block px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-lg transition">
                List Your First Car
            </a>
        </div>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/CBS/resources/views/dashboard/seller.blade.php ENDPATH**/ ?>