        ...
        <div class="dashboard-card text-center">
            ...
            <?php if(isset($reference)): ?>
                <div class="mt-6 rounded-lg bg-amber-50 border border-amber-200 p-4">
                    <p class="text-sm text-gray-700">Reference code: <strong class="text-amber-700 font-mono"><?php echo e($reference); ?></strong></p>
                    <p class="text-xs text-gray-500 mt-1">Your session has been invalidated for security.</p>
                </div>
            <?php endif; ?>
            <div class="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center">
                <a href="<?php echo e(route('login')); ?>" class="btn-primary inline-flex justify-center">Sign in again</a>
                <a href="<?php echo e(route('dashboard')); ?>" class="btn-secondary inline-flex justify-center">Dashboard</a>
            </div>
        </div>
    </div>
</body>
</html><?php /**PATH /opt/lampp/htdocs/CBS/resources/views/errors/419.blade.php ENDPATH**/ ?>