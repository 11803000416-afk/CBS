<?php $__env->startSection('title', 'My Vehicle Listings'); ?>
<?php $__env->startSection('subtitle', 'Manage your cars for sale or exchange'); ?>
...
<div class="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
    <div>
        <p class="text-lg font-semibold text-gray-900">
            <span class="text-blue-600 font-bold text-2xl"><?php echo e($vehicles->total()); ?></span>
            <span class="text-gray-600">active listings</span>
        </p>
    </div>
    <a href="<?php echo e(route('my-vehicles.create')); ?>" class="w-full sm:w-auto bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white px-6 py-3 rounded-lg shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2 font-bold transform hover:-translate-y-0.5">
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
    <?php $__empty_1 = true; $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow overflow-hidden group">
            ...
            <div class="p-5">
                <!-- Brand and Model -->
                <h3 class="text-xl font-bold text-gray-900 mb-1"><?php echo e($vehicle->brand); ?> <span class="text-blue-600"><?php echo e($vehicle->model); ?></span></h3>
                ...
                <div class="flex gap-2">
                    ...
                    <a href="<?php echo e(route('my-vehicles.edit', $vehicle)); ?>" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold rounded-lg transition flex items-center justify-center gap-2">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                        </svg>
                        Edit
                    </a>
                    <form method="POST" action="<?php echo e(route('my-vehicles.destroy', $vehicle)); ?>" onsubmit="return confirm('Are you sure?')" class="inline">
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        <div class="col-span-full">
            <div class="bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 rounded-xl shadow-md border border-blue-200 p-12 text-center relative overflow-hidden">
                ...
                <a href="<?php echo e(route('my-vehicles.create')); ?>" class="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-6 py-3 rounded-lg shadow-md hover:shadow-xl transition-all font-medium relative z-10">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/CBS/resources/views/vehicles/my-vehicles.blade.php ENDPATH**/ ?>