...
<body class="relative min-h-screen flex items-center justify-center p-4 sm:p-6 overflow-hidden">
    ...
    <div class="relative z-10 w-full max-w-md">
        ...
        <div class="backdrop-blur-xl bg-white/95 border border-white/20 rounded-3xl p-8 sm:p-10 shadow-2xl relative overflow-hidden">
            ...
            <!-- Register Link -->
            <a href="{{ route('register') }}" class="w-full block text-center px-4 py-3 rounded-xl border-2 border-cyan-500 text-cyan-600 hover:bg-cyan-50 font-bold transition-all hover:translate-y-[-2px] text-base">
                Create Account
            </a>
        </div>
        ...
        <div class="text-center mt-10">
            <p class="text-cyan-200/60 text-sm font-medium">© {{ date('Y') }} CBS - Car Broker System</p>
