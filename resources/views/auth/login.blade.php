...
<body class="aurora-bg min-h-screen flex items-center justify-center p-3 sm:p-4 md:p-6">
    <div class="w-full max-w-md relative z-10">
        ...
        <div class="glass-card rounded-2xl p-6 sm:p-8 shadow-2xl">
                ...
                <div class="mb-6 p-3 sm:p-4 rounded-lg bg-red-500/20 border border-red-500/30 backdrop-blur-sm animate-pulse">
                    <div class="flex items-start gap-2 sm:gap-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-xs sm:text-sm text-red-200">{{ $errors->first() }}</p>
                        </div>
                    </div>
                </div>
            @endif
            ...
            <form method="POST" action="{{ route('login.store') }}" class="space-y-4 sm:space-y-5">
                ...
                <div>
                    ...
                    @error('email')
                        <span class="text-red-400 text-xs sm:text-sm mt-1 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="mt-4 sm:mt-6 text-center text-xs sm:text-sm">
                <p class="text-gray-400">
                    ...
                    <a href="{{ route('register') }}" class="font-semibold text-blue-400 hover:text-blue-300 transition">
                        Create Account
                    </a>
                </p>
            </div>
        ...
        <div class="text-center mt-6 sm:mt-8 text-xs text-gray-400">
            <p>© {{ date('Y') }} CBS - Car Broker System. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
